...
const Parent = () => {
  ...
  const fetchSubjectsCourses = useCallback(async () => {
    try {
      setError('');
      ...
      setError('Error fetching subjects and courses');
      console.error(err);
    }
  }, [user.id]);
  ...
  }, [selectedCard, user, fetchSubjectsCourses, fetchAttendanceData, fetchPaymentData]);
  ...
  const renderContent = () => {
    switch(selectedCard) {
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {error ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-gray-500">Payment history will appear here</p>
              </div>
            )}
          </div>
        );
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {error ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-gray-500">Attendance records will appear here</p>
              </div>
            )}
          </div>
        );
      ...
      default:
        return (
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4">Welcome to Parent Dashboard</h2>
            <p className="text-gray-500">Select a menu item to view your child's information</p>
          </div>
        );
    }
  };
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <span className="hidden md:inline">
              Viewing: {student.firstName} {student.lastName} ({student.studentId})
            </span>
            <button 
      ...
      <main className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div 
            className={`bg-white rounded-lg shadow-md p-4 flex items-center cursor-pointer ${selectedCard === 'Student Details' ? 'ring-2 ring-blue-500' : ''}`}
            onClick={() => handleCardClick('Student Details')}
          >
          ...
          <div 
            className={`bg-white rounded-lg shadow-md p-4 flex items-center cursor-pointer ${selectedCard === 'Subjects & Courses' ? 'ring-2 ring-blue-500' : ''}`}
            onClick={() => handleCardClick('Subjects & Courses')}
          >
            <div className="bg-purple-100 p-3 rounded-full mr-4">
              <FaBook className="text-purple-600 text-xl" />
            </div>
            <div>
              <p className="text-gray-600">Subjects & Courses</p>
              <p className="text-lg font-semibold">{subjects.length + courses.length}</p>
            </div>
          </div>
